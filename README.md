...
and x minutes y seconds for a complete run. The main difference between the two parts is the speed of BIGILIB.PAS as the algorithm is otherwise identical.
